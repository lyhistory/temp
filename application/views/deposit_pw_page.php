...
<body>
	<div class="header_91">
		<p class="title">设置取现密码</p>
	</div>

	<div class="log_content">
        <form action ="<?php echo site_url("myaccount/setPayPassword");?>" method = "post" >
            <div class="inputs">
                <span>密码</span><input name="newpassword" type="password" placeholder="不少于6个字，字母和数字组成" id="newpassword"/>
            </div>
            <div class="inputs">
            ...
            <div class="account_content">
                <input class="button tuichu" type="submit" value="确定">
            </div>
