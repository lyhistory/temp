    ...
    <div class="pro_content">
        <div id="wrapper" style="height:100%;">
            ...
            <div class="pro_header">
                <a href="<?php echo site_url('ireits') ?>"><p class="pro_title this">I-REITS</p></a>
                <a href="<?php echo site_url('toufang') ?>"><p class="pro_title ">投房宝</p></a>
            </div>
 <div class="i_reits">
            <ul id="ireitsList">
                <input id ="i_totalPage"   type="hidden" value = "<?php echo $total_page?>">
                <?php foreach ($borrow as $item):?>
                    <li><a  href="<?php echo site_url('ireits/detailPage').'/'.$item['i_id'] ?>">
                            <div class="project">
                                <div class="img"><img    src='<?= $item['i_img'] ?>' /></div>
